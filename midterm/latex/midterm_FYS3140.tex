...
\end{equation}
here we used the double derivatives calculated in \eqref{derivatives}, and find that $u$ is harmonic. We now want to find the harmonic conjugate of $u$, which we can calculate through the definition of harmonic conjugates \eqref{harmonic_def}.
%%%%%%%%%%%%%%%%%%%%%%%%%%%% Main document
